...
def main(model = 'alexnet'):
    ...
    Y_sen_list = np.load(main_dir+"Y_sen_list" + model + "_HRS.npy")
    ...
    np.save("SenMap_HRS/Y"+model, Y_mean_lst)
    del Y_sen_img
    
    Cb_sen_list = np.load(main_dir+"Cr_sen_list" + model + "_HRS.npy")
    ...
    np.save("SenMap_HRS/Cb"+model, Cb_mean_lst)
    del Cb_sen_img

    Cr_sen_list = np.load(main_dir+"Cb_sen_list" + model + "_HRS.npy")
    ...
    np.save("SenMap_HRS/Cr"+model, Cr_mean_lst)
    del Cr_sen_img
