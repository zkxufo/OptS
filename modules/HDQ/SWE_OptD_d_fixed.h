...
float HDQ_OptD::__call__(vector<vector<vector<float>>>& image, vector<float>& q_table){
    ...
    quantizationTable_OptD_Y(Sen_Map_ones, seq_dct_coefs_Y, HDQ_OptD::Q_table_Y, 
...
// ------------------------------------- CbCr -----------------------------------------------
    ...
    quantizationTable_OptD_C(Sen_Map_ones, seq_dct_coefs_Cb, seq_dct_coefs_Cr, HDQ_OptD::Q_table_C
